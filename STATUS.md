...
**Status:** Phases 1-2 SHIPPED (Phase 1: 2026-08-24, Phase 2: 2026-08-25) — live
on GitHub Pages.
...
- Offline support: service worker (`sw.js`, cache `bab-v3` as of the Phase 2
...
- Deployed: pushed to `main` on `turlockmike/build-a-brain`, GitHub Pages
  ...
  post-deploy, for both the Phase 1 and Phase 2 ships.

## Pending — next session(s)

- **Phases 3-14 have no lesson content yet** — only their phase titles show
...
- Next up: Phase 3, "How Brains Work — neurons, signals, synapses as
  connection strength." Needs its own lesson-title breakdown (like Phase 1
  and 2 got) before full lesson content in the same schema.
